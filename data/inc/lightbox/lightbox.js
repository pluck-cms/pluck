...
var Lightbox = {	
	...
	initialize: function(options) {
		...
		this.options = $H({
			...
			strings : { // allows for localization
				closeLink : 'close',
				loadingMsg : 'loading',
				nextLink : '<img src="data/inc/lightbox/images/control_next.png" alt="" />',
				prevLink : '<img src="data/inc/lightbox/images/control_prev.png" alt="" />',
				startSlideshow : '<img src="data/inc/lightbox/images/control_play.png" alt="" />',
				stopSlideshow : '<img src="data/inc/lightbox/images/control_pause.png" alt="" />',
				numDisplayPrefix : '<img src="data/inc/lightbox/images/picture.png" alt="" />',
				numDisplaySeparator : '/'
			}
        }).merge(options);
	...
	updateDetails: function() {
		...
		if(this.imageArray.length > 1){
			var num_display = '<table><tr><td>' + this.options.strings.numDisplayPrefix + '</td><td>' + eval(this.activeImage + 1) + ' ' + this.options.strings.numDisplaySeparator + ' ' + this.imageArray.length + '</td></tr></table>';
...
Event.observe(window,'load',function(){ Lightbox.initialize({autoPlay:false,slideTime:7}); });